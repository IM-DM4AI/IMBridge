...
OB_STMT_TYPE_DEF(T_CREATE_PYTHON_UDF, no_priv_needed, 304, ACTION_TYPE_CREATE_PYTHON_UDF)
OB_STMT_TYPE_DEF(T_DROP_PYTHON_UDF, no_priv_needed, 305, ACTION_TYPE_DROP_PYTHON_UDF)
OB_STMT_TYPE_DEF(T_IMLANE_CONTROL, no_priv_needed, 308, ACTION_TYPE_LAUNCH_IMLANE)
